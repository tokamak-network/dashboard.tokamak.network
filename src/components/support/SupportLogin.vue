<template>
  <div>
    ...
    <ol>
      <li class="description" style="margin-left:-10px; margin-bottom:10px">Make sure you are connected to the Ethereum Mainnet network. Then click <span style="font-weight:bold">Connect Wallet</span> button </li>
      <li class="description" style="margin-left:-10px; margin-bottom:10px">click the <span style="font-weight:bold">Metamask</span> icon on the pop-up. </li>
      <li class="description" style="margin-left:-10px; margin-bottom:10px">
        Click on the Metmask icon of your brower extensions list and select the account you want to connect to our serivce.
      </li>
    </ol>
    ...
    <ol>
      <li class="description" style="margin-left:-10px; margin-bottom:10px">Click the <span style="font-weight:bold">Connect Wallet</span> button. </li>
      <li class="description" style="margin-left:-10px; margin-bottom:10px"> Click the WalletConnect icon on the pop-up. </li>
      <li class="description" style="margin-left:-10px; margin-bottom:10px">
    ...
    <div class="image-container">
      <img class="screenshot" src="@/assets/images/support/connect_03.png">
